...
public class Rogue : NPC, IHasDialogue
{
    ProfilePics pics;
    ...
    void Start()
    {
        ...
        Slide1Option1_NextSlide.SetValues(this.pics.Rogue, "omg yay!");
        ...
        Slide1Option2_NextSlide.SetValues(this.pics.Rogue, "Go fuck yourself.");
        ...
        Slide1.SetValues(this.pics.Rogue, "You want to buy?", new List<DialogueOptionButton>() { Slide1Option1, Slide1Option2});
